...
# --------------------------------------------------------------------------------------
# Función: poblar_areas_y_productos
# --------------------------------------------------------------------------------------
def poblar_areas_y_productos():
    db = get_db()
    areas = db["areas"]
...
# --------------------------------------------------------------------------------------
# Función: poblar_clientes
# --------------------------------------------------------------------------------------
def poblar_clientes(n=500_000, batch_size=10_000):
    db = get_db()
    productos_col = db["productos"]
...
# --------------------------------------------------------------------------------------
def poblar_base_local():
    poblar_usuarios()
    poblar_areas_y_productos()
    poblar_clientes()
    print("\nBase de datos local poblada exitosamente.")
